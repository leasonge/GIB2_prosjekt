...
const Map: React.FC = () => {
  useEffect(() => {
    ...
    map.on('load', () => {
      ...
      map.on('mouseenter', 'places', (e) => {
        ...
        popup.setLngLat(coordinates).setHTML(description).setOffset(offset).addTo(map);
      });
  ...
  return (<>
    <div id="map" style={{ width: '100%', height: '750px', top:88 }}></div>
    <div id="instructions">
        <h3>Hvor vil du reise?</h3>
        <p>Hold over punktene i kartet for å finne navn på hotellene</p>
